// Временный файл для добавления изображений к активностям
// Запустите через консоль на странице приложения

const activityImageUrls: Record<string, string> = {
  // День 1
  ...
  'Продолжение маршрута': 'https://images.unsplash.com/photo-1501555088652-021faa106b9b?w=800&q=80',
  'Установка лагеря': 'https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?w=800&q=80',
...
export default activityImageUrls;